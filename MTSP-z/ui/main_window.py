...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.Main_QF.setStyleSheet(u"QFrame#Main_QF{\n"
                                           "   background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(135,194,210), stop:1 rgb(156,217,218));\n"
                ...
                # ------------------------------------------------------- 侧边栏
                self.logo.setStyleSheet(u"image: url(:/all/img/long.png);\n"
                                        "border:2px solid rgb(135,194,210);\n"
                                        "border-radius: 0px;")
                ...
                self.Author.setStyleSheet(u"font: 600 13pt \"STLiti\";\n"
                                          "color: orange;")
                ...
                self.Title.setStyleSheet(u"font: 600 13pt \"STLiti\";\n"
                                         "color:orange;")
                ...
                # 区域标点
                self.punctuation_detection_button = QPushButton(self.MenuBox)
                self.punctuation_detection_button.setObjectName(u"punctuation_detection_button")
                self.punctuation_detection_button.setMinimumSize(QSize(0, 45))
                self.punctuation_detection_button.setCursor(QCursor(Qt.PointingHandCursor))
                self.punctuation_detection_button.setStyleSheet(u"QPushButton{\n"
                                                                "background-image: url(:/all/img/area.png);\n"
                                                                "background-repeat: no-repeat;\n"
                                                                "background-position: left center;\n"
                                                                "border: none;\n"
                                                                "border-left: 23px solid transparent;\n"
                                                                ...
                                                                "background-color: rgba(114, 129, 214, 59);\n"
                                                                "}")
                self.verticalLayout_5.addWidget(self.punctuation_detection_button)
                ...
                self.explain_title.setStyleSheet(u"font: 900 14pt \"STKaiti\"; color: rgb(0, 0, 0);")
                ...
                self.prm_page.setStyleSheet(u"QFrame#prm_page{\n"
                                            "background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(254,153,139),  stop:1 rgb(251,165,199));\n"
                ...
                self.iou_slider.setStyleSheet(u"QSlider::groove:horizontal {\n"
                                              ...
                                              "background-color: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 rgb(240, 124, 130),  stop:1 rgb(238,130,238));\n"
                                              "border-radius: 5px;\n"
                                              "}")
                ...
                self.speed_slider.setStyleSheet(u"QSlider::groove:horizontal {\n"
                                                ...
                                                "\n"
                                                "QSlider::sub-page:horizontal {\n"
                                                "background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(240, 124, 130),  stop:1 rgb(238,130,238));\n"
                                                "border-radius: 5px;\n"
                                                "}")
                # 延时 滑块
                self.iou_slider.setMinimum(1)
                ...
                self.below.setStyleSheet(u"QFrame#below{\n"
                                         "   background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(255,235,205), stop:1 rgb(255,250,205));\n"
                                         "border:0px solid red;\n"
                                         "border-radius:30px\n"
                                         "}")
                ...
                self.status_bar.setStyleSheet(u"font: 700 14pt \"STXingkai\";\n"
                                              "color: rgba(0, 0, 0, 140);")
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.Author.setText(QCoreApplication.translate("MainWindow", u"霸气天下", None))
                self.Title.setText(QCoreApplication.translate("MainWindow", u"龙腾万里", None))
                ...
                self.punctuation_detection_button.setText(QCoreApplication.translate("MainWindow", u"区域标定", None))
                ...
                self.explain_title.setText(QCoreApplication.translate("MainWindow", u"基于大模型的车流检测系统", None))
